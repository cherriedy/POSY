...
import { PromotionRedemption } from '../entities/promotion-redemption';
import { PromotionRedemptionMapper } from '../entities/promotion-redemption.mapper';

@Injectable()
export class PrismaPromotionRedemptionRepository implements PromotionRedemptionRepository {
