...
import { PromotionCategory } from '../entities/promotion-category';
import { PromotionCategoryMapper } from '../entities/promotion-category.mapper';
import { Injectable } from '@nestjs/common';
import { PrismaService } from '@posy/shared';
import { PromotionStatus } from '@prisma/client';

@Injectable()
export class PrismaPromotionCategoryRepository implements PromotionCategoryRepository {
