...
import { PromotionProduct } from '../entities/promotion-product';
import { PromotionProductMapper } from '../entities/promotion-product.mapper';
import { Injectable } from '@nestjs/common';
import { PrismaService } from '@posy/shared';
import { PromotionStatus } from '@prisma/client';

@Injectable()
export class PrismaPromotionProductRepository implements PromotionProductRepository {
