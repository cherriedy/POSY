...
import { UnavailableTableException } from '../../shared/errors/unavailable-table.exception';
import { TableSessionNotFoundException } from '../../shared/errors/table-session-not-found.exception';
