...
import { SessionPreferenceNotFoundException } from '../errors/session-preference-not-found.exception';
...
@Injectable()
export class PrismaSessionPreferenceRepository implements SessionPreferenceRepository {
