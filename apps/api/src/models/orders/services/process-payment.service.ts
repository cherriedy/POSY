...
import { PromotionRedemptionMapper } from '@posy/promotions/shared/entities/promotion-redemption.mapper';
...
import { PaymentStatus } from '@posy/payments/shared/enums/payment-status.enum';
